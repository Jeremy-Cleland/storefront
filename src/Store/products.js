const initialState = [
  ...
  },
  {
    ...
    description:
      "The 16-inch MacBook Pro with M2 Pro and M2 Max takes power and speed to the next level, whether it's on battery or.",
    image:
  ...
  },
  {
    ...
    description:
      "Apple's thinnest and lightest notebook gets supercharged with the Apple M1 chip. Tackle your projects with the...",
    image:
  ...
  },
  {
    ...
    description:
      "The Apple M1 chip redefines the 13-inch MacBook Pro. Featuring an 8-core CPU that flies through complex workflows",
    image:
  ...
  },
  {
    ...
    description:
      "The new MacBook Pro delivers game-changing performance for pro users. Choose the powerful M1 Pro or the even more ",
    image:
  ...
  },
  {
    ...
    description:
      "The new iPad mini. Featuring an all-screen design with an 8.3-inch Liquid Retina display. Powerful A15 Bionic chip ",
    image:
  ...
  },
  {
    ...
    description:
      "iPad Pro features the powerful Apple M1 chip with next-level performance and all-day battery life.The Liquid .",
    image:
  ...
  },
  {
    ...
    description:
      "With the new Wireless Charging Case, charging is as simple as placing your AirPods in the case and laying it on a.",
    image:
  ...
  },
  {
    ...
    description:
      "AirPods Max reimagine over-ear headphones. An Apple-designed dynamic driver provides immersive high-fidelity .",
    image:
